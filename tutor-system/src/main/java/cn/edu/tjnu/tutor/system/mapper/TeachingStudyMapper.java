...
public interface TeachingStudyMapper extends BaseMapper<TeachingStudy> {
     ...
     * @return 分页对象
     */
    <P extends IPage<TeachingStudyVO>> P selectPageVO(@Param("userId") Integer userId, P page);
